...
- (void)viewDidLoad
{
    ...
    //Параметры кнопки buttonMainMenu----------------------------------
    
    [self.buttonMainMenu addTarget:self action:@selector(actionButtonMainMenu)
                              forControlEvents:UIControlEventTouchUpInside];
...
//Реализация кнопки buttonMainMenu-----------------------

- (void)actionButtonMainMenu
{
