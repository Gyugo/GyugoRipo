...
- (void) workstations { // Рабочие станции
    [self nameDepartmentWorstation:@"Административный отдел" departmentsWorkstations:@"Mac OS" processorName:@"Intel i3" processorFrequency:3.0f ramName:@"Kingston" ramVolume:16.f];
