...
- (void) quarterlyObjectives {  //Список квартальных премий
...
- (void) quarterlyObjectivesIT { //Задачи IT
...
- (void) quarterlyObjectivesHR { //Задачи HR
    if ([self performance] == 1) {
...
- (void) quarterlyObjectivesFinancial { //Задачи финансистов
    if ([self performance] == 1) {
...
- (void) quarterlyObjectivesSales { //Задачи Отдела продаж
    if ([self performance] == 1) {
...
- (void) quarterlyAward: (NSInteger) value1 quarterlyNameDepartment: (NSString*) str { // квартальная премия
